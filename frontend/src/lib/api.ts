...
export function saveSession(token:string,user:unknown){localStorage.setItem("empleaterd_token",token);localStorage.setItem("empleaterd_user",JSON.stringify(user));}
